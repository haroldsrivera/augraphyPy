...
filter_names = [
    ...
    "LowInkRandomLines",
    "LowInkPeriodicLines",
    # Agrega aquí los nombres de otros filtros en el mismo orden
]

for i, (ink, paper, post) in enumerate(zip(ink_phase, paper_phase, post_phase)):
    print("Aplicando filtro:", filter_names[i])

    augmented_data = pipeline.augment(image)
    augmented_image = augmented_data['output']
